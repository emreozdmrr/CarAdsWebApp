...
{
	public class AdvertisementCreateModelValidator:AbstractValidator<AdvertisementCreateModel>
	{
        public AdvertisementCreateModelValidator()
        {
            ...
            RuleFor(x => x.ImageUrl).NotEmpty().WithMessage("Lütfen ilan görseli yükleyiniz!");
        }
    }
}
